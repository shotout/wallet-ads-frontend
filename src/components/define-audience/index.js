...
// @mui
import { MenuItem, TextField, Select, Typography, Checkbox, ListItemText, Grid, Popover, Box } from '@mui/material';
...
const questionObj = {
  cryptocurrencies_used:
    'Target users that own specific cryptocurrencies. If you select several cryptocurrencies, you will target all users that own at least one of the chosen cryptocurrencies.',
  account_age: 'Target users whose cryptowallet accounts already exist for a certain amount of time.',
  available_credit_in_wallet:
    'Target users who have a certain amount of credit in their wallet (daily updated equivalent in USD)',
  ...
  nft_Purchases:
    'Target users who made purchases of a certain Creator or NFT. You can freely add several creators or NFTs here by separating them with a comma.',
  upload_audience:
    'If you have a list of wallet addresses that you would like to target, you can upload it here. File format: .xlsx or .csv - max. file size 8mb.',
};

const targetIcon = '/assets/svg/target_background.svg';
const askSvg = '/assets/svg/ask.svg';

const listAirdropReceived = ['Select...', '0', '1-5', '6-10', '>10'];

const listAmountTransaction = ['-', '0', 'Min. 1', 'Min. 5', 'Min. 10'];

const listAvailableCredit = ['Select...', 'USD0', 'Min. USD1', 'Min. USD100', 'Min. USD1,000', 'Min. USD100,000'];
  ...
  useEffect(() => {
    if (activeAudience !== selectedAudience) {
      ...
      setFormValues({
        ...
        optimized: true,
        selectedCategory:
          initialData.optimized && initialData.selectedCategory ? initialData.selectedCategory : 'optimized',
      });
    }
  }, [selectedAudience]);
      ...
      <div className={styles.ctnInputTarget}>
        <div className={styles.ctnLeftInputTarget}>
          <div className={styles.ctnTitleInput}>
            ...
            <div
              className={styles.askCtn}
              onMouseEnter={(event) => {
                handleHoverOpen(event, 'cryptocurrencies_used');
              }}
            ...
            >
              ...
              <SvgIconStyle
                src={askSvg}
                sx={{ width: 1, height: 1, color: getCategoryColor('detail-targeting', '#8C65CC') }}
              />
            </div>
          </div>
          <div className={styles.ctnInputMultipleSelect}>
            <Select
              ...
              value={
                formValues.balancedTargeting.cryptoCurrency
                  ? formValues.balancedTargeting.cryptoCurrency
                  : ['Select...']
              }
              onChange={(target) => {
                handleChangeBalanceTarget(target, 'cryptoCurrency');
              }}
                  ...
                  <MenuItem className={styles.txtOption} key={option} value={option}>
                    <Checkbox
                      ...
                      checked={
                        formValues.balancedTargeting &&
                        formValues.balancedTargeting.cryptoCurrency &&
                        formValues.balancedTargeting.cryptoCurrency.indexOf(option) > -1
                      }
                    />
        ...
        <div className={styles.ctnRightTarget}>
          <div className={styles.ctnTitleInput}>
            ...
            <div
              className={styles.askCtn}
              onMouseEnter={(event) => {
                handleHoverOpen(event, 'account_age');
              }}
              onMouseLeave={handleHoverClose}
            >
          ...
          <div className={styles.ctnRowInput}>
            <div
              className={`${styles.ctnGrayInput} ${
                !formValues.balancedTargeting.year ? styles.ctnGrayInputDisable : {}
              }`}
            >
              <input
                disabled={!isCategorySelected('detail-targeting')}
                ...
                onChange={(target) => {
                  handleChangeBalanceTarget(target, 'year');
                }}
                placeholder="-"
                type={'text'}
              />
              <Typography variant="body2">
                {isNaN(formValues.balancedTargeting.year) || Number(formValues.balancedTargeting.year) <= 1
                  ? 'Year'
                  : 'Years'}
              </Typography>
            </div>
            <div
              className={`${styles.ctnGrayInput} ${
                !formValues.balancedTargeting.months ? styles.ctnGrayInputDisable : {}
              }`}
            >
              <input
                disabled={!isCategorySelected('detail-targeting')}
                value={formValues.balancedTargeting.months}
                onChange={(target) => {
                  handleChangeBalanceTarget(target, 'months');
                }}
                placeholder="-"
                type={'text'}
              />
              <Typography variant="body2">
                {isNaN(formValues.balancedTargeting.months) || Number(formValues.balancedTargeting.months) <= 1
                  ? 'Month'
                  : 'Months'}
              </Typography>
            </div>
            <div
              className={`${styles.ctnGrayInput} ${
                !formValues.balancedTargeting.day ? styles.ctnGrayInputDisable : {}
              }`}
            >
              <input
                disabled={!isCategorySelected('detail-targeting')}
                ...
                onChange={(target) => {
                  handleChangeBalanceTarget(target, 'day');
                }}
                placeholder="-"
                type={'text'}
              />
              <Typography variant="body2">
                {isNaN(formValues.balancedTargeting.day) || Number(formValues.balancedTargeting.day) <= 1
                  ? 'Day'
                  : 'Days'}
              </Typography>
            </div>
        ...
        <div className={styles.ctnLeftInputTarget}>
          <div className={styles.ctnTitleInput}>
            ...
            <div
              className={styles.askCtn}
              onMouseEnter={(event) => {
                handleHoverOpen(event, 'available_credit_in_wallet');
              }}
              onMouseLeave={handleHoverClose}
            >
          ...
          <div className={styles.ctnInputSelect}>
            <TextField
              ...
              disabled={!isCategorySelected('detail-targeting')}
              value={
                formValues.detailTargeting ? formValues.detailTargeting.availableCredit || 'Select...' : 'Select...'
              }
              onChange={(target) => {
                handleChangeDetailTarget(target, 'availableCredit');
              }}
            >
        ...
        <div className={styles.ctnLeftBalance}>
          <div className={styles.ctnTitleInput}>
            ...
            <div
              className={styles.askCtn}
              onMouseEnter={(event) => {
                handleHoverOpen(event, 'trading_volume');
              }}
              onMouseLeave={handleHoverClose}
            >
          ...
          <div className={styles.ctnInputSelect}>
            <TextField
              ...
              onChange={(target) => {
                handleChangeDetailTarget(target, 'tradingVolume');
              }}
            >
              {listAvailableCredit.map((option) => (
                <MenuItem className={styles.txtOption} key={option} value={option}>
        ...
        <div className={styles.ctnLeftBalance}>
          <div className={styles.ctnTitleInput}>
            ...
            <div
              className={styles.askCtn}
              onMouseEnter={(event) => {
                handleHoverOpen(event, 'airdrops_received');
              }}
              onMouseLeave={handleHoverClose}
            >
          ...
          <div className={styles.ctnInputSelect}>
            <TextField
              ...
              onChange={(target) => {
                handleChangeBalanceTarget(target, 'airdropReceived');
              }}
            >
  ...
  function renderComingSoonInput() {
    return (
      <div className={styles.ctnInputTarget}>
        <div className={styles.ctnLeftInputTarget}>
          <div className={styles.ctnTitleInput}>
            <Typography variant="body2">+Add lookalike wallets</Typography>
          ...
          <div className={styles.inputSectionLeft}>
            <div className={styles.ctnTitleInput}>
              ...
              <div
                className={styles.askCtn}
                onMouseEnter={(event) => {
                  handleHoverOpen(event, 'amount_of_transaction');
                }}
                onMouseLeave={handleHoverClose}
              >
            ...
            <div className={styles.amountInputWrapper}>
              <div
                className={`${styles.ctnInputSelectAmount} ${
                  !isCategorySelected('detail-targeting') ? styles.grayArrowBg : {}
                }`}
              >
                <TextField
                  select
                  ...
                  onChange={(target) => {
                    handleChangeDetailTarget(target, 'transactionAmount');
                  }}
                >
              ...
              <div
                className={`${styles.ctnInputRawAmount} ${
                  !formValues.detailTargeting.amountDays ? styles.ctnGrayInputDisable : {}
                }`}
              >
                <input
                  disabled={!isCategorySelected('detail-targeting')}
                  ...
                  onChange={(target) => {
                    handleChangeDetailTarget(target, 'amountDays');
                  }}
                  placeholder="-"
                  type="text"
                  id="campaign"
              ...
              <div
                className={`${styles.ctnInputRawAmount} ${checkIsCategoryActive('detail-targeting')} ${
                  styles.bdRightAmount
                }`}
              >
                <span>days</span>
              </div>
          ...
          <div className={styles.inputSectionLeft}>
            <div className={styles.ctnTitleInput}>
              ...
              <div
                className={styles.askCtn}
                onMouseEnter={(event) => {
                  handleHoverOpen(event, 'nft_Purchases');
                }}
                onMouseLeave={handleHoverClose}
              >
            ...
            <div className={styles.inputCollectionWrapper}>
              <input
                ...
                onChange={(target) => {
                  handleChangeDetailTarget(target, 'creatorName');
                }}
                placeholder="Add creator here"
                type="text"
                id="campaign"
                name="campaign"
              />
      ...
      >
        <div className={styles.ctnHeader}>
          <div className={styles.ctnBgBtn}>
            <SvgIconStyle
              src={targetIcon}
              sx={{ width: 1, height: 1, bgcolor: getCategoryColor('optimized', '#90B272') }}
            />
          </div>
          <div
            className={styles.ctnLeftHeader}
            onClick={() => {
              onChangeBasicValue('selectedCategory', 'optimized');
            }}
          >
      ...
      >
        <div className={styles.ctnHeader}>
          <div className={styles.ctnBgBtn}>
            <SvgIconStyle
              src={targetIcon}
              sx={{ width: 1, height: 1, bgcolor: getCategoryColor('detail-targeting', '#8C65CC') }}
            />
          </div>
      ...
      >
        <div className={styles.ctnHeader}>
          <div className={styles.ctnBgBtn}>
            <SvgIconStyle
              src={targetIcon}
              sx={{ width: 1, height: 1, bgcolor: getCategoryColor('upload', '#AD4061') }}
            />
          </div>
          <div
            className={styles.ctnLeftHeader}
          ...
          <div className={styles.ctnHeaderTitle}>
            <div className={styles.ctnRowTitle}>
              ...
              <div
                className={styles.askCtn}
                onMouseEnter={(event) => {
                  handleHoverOpen(event, 'upload_audience');
                }}
                onMouseLeave={handleHoverClose}
              >
        ...
        <div className={`${styles.ctnInputTarget} ${styles.borderRed}`}>
          <FilePicker
            btnStyle={checkIsCategoryActive('upload', true)}
            onDelete={removeFile}
            typeScreen={'logo'}
            file={formValues.audienceFile}
            label="Upload File"
            onDrop={(value) => {
      ...
      <div className={styles.ctnRightContent}>
        <CardAudienceSummary
          onChangeBudget={(event) => {
            onChangeBasicValue('budgetAds', event.target.value);
          }}
          isEdit
